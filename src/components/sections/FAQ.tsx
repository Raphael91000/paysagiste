...
const faqs: FAQItem[] = [
  {
    question: "Intervenez-vous uniquement sur [Ville] ou dans toute la région ?",
    answer:
      "Nous intervenons dans un rayon de 50 km autour de [Ville], ce qui couvre la grande majorité des communes de la région. N'hésitez pas à nous contacter pour vérifier si votre adresse est dans notre zone — dans le doute, la visite initiale est toujours gratuite.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolument. Jardins & Co est membre de l'UNEP (Union Nationale des Entrepreneurs du Paysage), certifié RGE (Reconnu Garant de l'Environnement) et dispose d'une assurance décennale ainsi qu'une responsabilité civile professionnelle à jour. Nous pouvons vous fournir toutes les attestations sur simple demande.",
  },
  {

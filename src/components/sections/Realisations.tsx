...
const realisations: Realisation[] = [
  {
    ...
    title: "Jardin contemporain — [Ville]",
  ...
  },
  {
    ...
    title: "Massif de vivaces — [Village]",
    gridClass: "col-span-1 row-span-1",
    aspectClass: "aspect-[4/3]",
  },
  {

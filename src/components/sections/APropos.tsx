...
export default function APropos() {
  return (
    <section
      ...
      aria-label="À propos de Jardins & Co"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <AnimatedSection direction="left" className="relative">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden max-w-md mx-auto lg:mx-0">
              <Image
                ...
                alt="Portrait du paysagiste fondateur de Jardins & Co"
                fill
          ...
          <AnimatedSection delay={0.15} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-sage leading-relaxed">
              ...
              <p>
                Depuis 2008, Jardins &amp; Co accompagne des centaines de
                familles et d&apos;entreprises de la région [Ville] dans la
            ...
            <p className="text-sage text-xs -mt-3">Fondateur, Jardins &amp; Co</p>
          </AnimatedSection>
        </div>
      </div>
    </section>
